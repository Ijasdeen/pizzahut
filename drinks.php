...
<main>
    <section class="drinks-beverages">
        <div class="container">
          <div class="row">
                  <?php
               ...
               while($row=mysqli_fetch_array($result)){
                   ?>
                       ...
                       <div class="col-md-3 mb-3">
                           <div class="card">
  <img class="card-img-top img-fluid" src="Images/bevarages/<?php echo $row['image']?>" alt="<?php echo $row['name']?>">
  <div class="card-body">
    ...
    <a href="javascript:void(0)" 
            ...
            category='beverages'    
            image= 'Images/bevarages/<?php echo $row['image']?>'  
                quantity = '1'    
                >Add to cart</a>
  </div>
</div>
