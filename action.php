                            ...
                            <div class="quantity-area">
                                <label for="QuantityLabel">Quantity</label>
                                 <div class="d-flex justify-content-center mb-3">
                                     ...
                                     <div class="p-1"><input type="text" value="<?php echo $values['item_quantity']?>" min="1" id="value" size="1" pattern="[0-9]+" class="quantityValue" dataId="<?php echo $values['item_id']?>" category_name="<?php echo $values['category_name']?>"></div>
